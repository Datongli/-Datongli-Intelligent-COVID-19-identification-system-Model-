...
class parallel_net(nn.Module):
    def __init__(self, num_classes=2, dropout=0.2):
        ...
        self.part_1 = ResNet.resnet18(num_classes=256, include_top=True, dropout=self.dropout)
        # self.part_1 = Covnet_3.Covnet(drop_1=0.2, drop_2=0.2)
        # 部分二用于承接对数梅尔倒谱图，暂定使用resnet网络，最后两个节点
        # self.part_2 = ResNet.resnet34(num_classes=256*2, include_top=True, dropout=self.dropout)
