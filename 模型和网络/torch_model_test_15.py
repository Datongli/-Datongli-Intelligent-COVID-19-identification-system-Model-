...
# 数据集文件夹位置
filepath_1 = r"D:\学习\大创\data\训练数据集\data\logMel 1：1"
filepath_2 = r"D:\学习\大创\data\训练数据集\data\TFDF"
...
class PaddyDataSet(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 得到类别二的路径 img_path_2
        path_img_2 = os.path.join(filepath_2, img_class, img_name)
...
# -------------------------------------------------- #
# 计算图片的总数量
negative_path = filepath_1 + "\\" + negative
positive_path = filepath_1 + "\\" + positive
...
# 显示一下文件夹的名称
dir_count_1 = filepath_1.rfind('\\') + 1
dir_path_1 = filepath_1[dir_count_1:]
dir_count_2 = filepath_2.rfind('\\') + 1
dir_path_2 = filepath_2[dir_count_2:]
...
# 读取数据集后再进行划分
data_dir_1 = filepath_1
data_dir_2 = filepath_2
# transform = transforms.Compose([transforms.ToTensor()])
# all_dataset_1 = ImageFolder(root=filepath_1 + '/', transform=transform)
# image_mean_1, image_std_1 = getStat(all_dataset_1)
# all_dataset_2 = ImageFolder(root=filepath_2 + '/', transform=transform)
# image_mean_2, image_std_2 = getStat(all_dataset_2)
# print(image_mean_1, image_std_1)
# print(image_mean_2, image_std_2)
image_mean_1 = [0.42746902, 0.6474644, 0.4993739]
image_std_1 = [0.38065454, 0.35554656, 0.3535182]
image_mean_2 = [0.4948011, 0.9231663, 0.47740427]
image_std_2 = [0.24248195, 0.14762484, 0.2365019]
# 实例化一个对象
data_0 = PaddyDataSet(data_dir_1=data_dir_1,
